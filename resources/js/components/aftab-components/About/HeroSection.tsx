      ...
      >
        ...
        >
          ...
          <p
            ...
            "
          >
            <span className="text-brand">Menopause</span> is a universal
            experience, yet millions of women still feel unheard, uninformed,
            and unsupported. The journey can bring physical changes, emotional
            challenges, and shifts in identity — and too often, the systems
            meant to help fall short.
          </p>
